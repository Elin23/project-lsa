    ...
    >
      ...
      >
        ...
        {details.length > 0 ? (
          ...
          <p className="mt-8 text-sm text-muted-blue">
      ...
      >
        <h4 className="text-2xl font-bold text-blue-01 sm:text-[40px]">
          {project.detailedScope.title}
        </h4>

        {project.detailedScope.description && (
          <p className="mt-3.5 text-lg font-light text-[#444651E5]">
            {project.detailedScope.description}
          </p>
        )}
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            {project.detailedScope.items.map((item) => (
              ...
              >
                ...
                <p className="mt-1 text-sm font-light text-[#444651E5]">
                  {item.description}
                </p>
              </div>
            ))}
