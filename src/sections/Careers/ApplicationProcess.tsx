    ...
    <section className="relative overflow-hidden mb-20">
      ...
      <div className="relative mx-auto ">
        ...
        <div className="mt-16 rounded-[2rem] shadow-sm  border border-slate-200 bg-white   md:p-10">
          <div className="relative grid gap-6 md:grid-cols-4">
            ...
            {applicationProcessData.map((item) => {
              ...
              return (
                ...
                >
                  <span
                    className={`mx-auto flex h-20 w-20 items-center justify-center rounded-2xl border-4 shadow-lg transition-all duration-300 ${
                      isActive
                  ...
                  <h3
                    className={`mt-2 text-lg font-bold transition ${
          ...
          <div className="mt-10 rounded-[1.5rem] bg-blue-01 p-8 text-white shadow-[0_20px_50px_rgba(30,58,138,0.22)] md:p-10">
