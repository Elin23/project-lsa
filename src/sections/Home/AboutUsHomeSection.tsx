    ...
    return (
        <>
            <div className=" flex justify-between flex-col lg:flex-row gap-16 ">
                ...
                <div className=" w-full lg:w-[47.29%] 2xl:w-[47.99%] space-y-6 text-center lg:text-start ">
                    <h2 className=" text-blue-01 text-[28px] md:text-[40px] lg:text-5xl 2xl:text-7xl font-bold  ">
                        Local Roots. Global Standards.
                    </h2>
                    <p className=" text-sm md:text-[20px] lg:text-2xl 2xl:text-[28px] text-muted-blue font-normal ">
