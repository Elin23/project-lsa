    ...
    <>
      <div className=" flex justify-between items-center flex-col lg:flex-row gap-16 ">
        <div className=" w-full lg:w-[47.29%] 2xl:w-[47.99%] h-max relative">
          <div className=" absolute inset-0 rounded-3xl bg-white-gray-03 rotate-[1.5deg]"></div>
        <div className=" w-full lg:w-[47.29%] 2xl:w-[47.99%]  h-max relative " data-aos="flip-up">
        ...
        <div data-aos="fade-up" className=" w-full lg:w-[47.29%] 2xl:w-[47.99%] space-y-5 md:space-y-6 2xl:space-y-8  text-center lg:text-start ">
          <h2 className=" text-blue-01 text-[30px] md:text-[40px] 2xl:text-5xl font-bold  ">
          ...
          >
            <span className="relative after:absolute after:left-0 after:-bottom-1 after:h-0.5 after:w-0 after:bg-red-01 after:transition-all after:duration-300 group-hover:after:w-full">
              Learn more about us
            </span>
