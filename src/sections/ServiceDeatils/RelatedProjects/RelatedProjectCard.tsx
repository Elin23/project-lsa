...
export default function RelatedProjectCard({ category, title, description, image, path }: RelatedProjectCardProps) {
  return (
    <div data-aos="fade-up" data-aos-duration="650" data-aos-easing="ease-out-cubic" data-aos-once="true" className="h-full cursor-pointer">
      <article className="group flex h-full flex-col overflow-hidden rounded-xl border border-[#E8EDF5] bg-white shadow-[0_8px_30px_rgba(31,63,147,0.08)] transition-[border-color,box-shadow] duration-500 ease-out hover:border-blue-01/15 hover:shadow-[0_18px_45px_rgba(31,63,147,0.14)]">
        {/* Image */}
        ...
        <div className="flex flex-1 flex-col p-6">
          <p className="line-clamp-3 text-sm leading-6 text-muted-blue lg:text-base 2xl:text-lg">{description}</p>

          <div className="mt-auto pt-5">
            <div className="mb-4 h-px w-full bg-[#E8EDF5]" />

            <Link to={path} className="group/link inline-flex cursor-pointer items-center gap-2 font-semibold text-red-01">
