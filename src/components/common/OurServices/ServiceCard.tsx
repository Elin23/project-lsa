...
export default function ServiceCard({
  ...
  return (
    <article
      ...
      data-aos-offset="60"
      data-aos-once="true"
      className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_16px_50px_rgba(15,35,70,0.08)] transition-all duration-500 hover:-translate-y-1 hover:border-blue-01/20 hover:shadow-[0_26px_70px_rgba(15,35,70,0.14)]"
    >
      <div className="grid lg:min-h-[390px] lg:grid-cols-[72px_1fr_0.9fr]">
        {/* Service number */}
        ...
        >
          ...
          <h3 className="mt-4 max-w-xl text-2xl font-extrabold leading-tight tracking-[-0.025em] text-blue-01 sm:text-[28px] xl:text-[30px]">
            {title}
          </h3>
        ...
        {/* Image */}
        <div
          className={`relative min-h-[250px] overflow-hidden sm:min-h-[300px] lg:min-h-full ${
