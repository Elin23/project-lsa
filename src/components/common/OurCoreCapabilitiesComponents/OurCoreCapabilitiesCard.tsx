...
export default function OurCoreCapabilitiesCard({
    ...
    return (
        <div className="w-full md:w-[48.21%] xl:w-[31.53%] 2xl:w-[32.01%] rounded-2xl border border-muted-blue/30 p-5 md:p-6 2xl:p-7 bg-white relative space-y-1.5 md:space-y-2  ">
