...
export default function LocationMap({
  ...
  return (
    <section className="relative left-1/2 w-screen -translate-x-1/2 overflow-hidden">
      <div className="relative h-[320px] w-full bg-[#ECEFF5] md:h-[420px] lg:h-[520px]">
        {!loaded && (
          <div className="absolute inset-0 z-10 animate-pulse bg-[#ECEFF5]">
            <div className="absolute inset-0 bg-[linear-gradient(35deg,transparent_48%,rgba(255,255,255,0.85)_49%,rgba(255,255,255,0.85)_51%,transparent_52%)] bg-[length:80px_80px]" />
