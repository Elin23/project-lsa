  ...
  return (
    <header
      className={`
        ...
        ${
          isScrolled
            ? "px-3 pt-3 md:px-[48px] md:pt-4 2xl:px-[162px]"
            : "px-0 pt-0"
        }
      `}
    >
      <div className="relative">
        <nav
          className={`
            ...
            ${
              isScrolled
                ? "rounded-2xl border border-blue-01/10 shadow-[0_12px_35px_rgba(0,35,111,0.12)] md:rounded-3xl max-w-[1596px] mx-auto"
                : "rounded-none"
            }
          `}
        >
          <NavLink to="/" className="flex items-center">
            <img
              src={logo}
              alt="LSA Logo"
              className="h-10 w-auto md:h-15 2xl:h-20"
            />
          </NavLink>
        ...
        <div
          className={`
            ...
            ease-[cubic-bezier(0.22,1,0.36,1)]
            lg:hidden
            ${isScrolled ? "mx-0" : "mx-3.5 rounded-t-none"}
            ${
              open
