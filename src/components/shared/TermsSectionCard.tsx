import type { TermsSection } from "../../data/termsAndConditionsData";
...
export default function TermsSectionCard({
  ...
  return (
    <article
      ...
      className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_12px_40px_rgba(15,35,70,0.055)]"
    >
