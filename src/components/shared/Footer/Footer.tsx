  ...
  return (
    <footer id="footer" className="relative overflow-hidden bg-[#06162d] text-white">
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -right-24 -top-24 h-[300px] w-[300px] rounded-full border border-white/[0.05]" />

        <div className="absolute right-[12%] top-[18%] h-52 w-52 rounded-full bg-blue-500/[0.05] blur-3xl" />

        <div className="absolute -bottom-32 -left-20 h-80 w-80 rounded-full bg-red-600/[0.04] blur-3xl" />

        <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.018)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.018)_1px,transparent_1px)] bg-[size:70px_70px] [mask-image:linear-gradient(to_bottom,black,transparent_78%)]" />
      </div>
            ...
            <div className="flex flex-wrap items-center gap-x-6 gap-y-3">
              {footerData.bottomLinks.map((link) => (
                <Link
                  key={link.label}
                  to={link.path}
                  className="relative text-xs font-medium text-white/40 transition-colors duration-300 after:absolute after:-bottom-1 after:left-0 after:h-px after:w-0 after:bg-red-01 after:transition-all after:duration-300 hover:text-white hover:after:w-full"
                >
                  {link.label}
                </Link>
              ))}
