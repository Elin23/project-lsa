                    ...
                    {({ isActive }) => (
                      <>
                        ...
                        <motion.span
                          ...
                          className="absolute bottom-4 left-2/5 h-0.75 -translate-x-1/2 rounded-t-full bg-red-01 group-hover:w-full"
                        />
                      </>
                    )}
                  </NavLink>
                  ...
                  <AnimatePresence>
                    {hasChildren && isDropdownOpen && (
                      <motion.div
                        ...
                        animate="visible"
                        exit="exit"
                        className="absolute left-1/2 top-full z-50 w-72.5 -translate-x-1/2 pt-4"
                      >
                        <div className="absolute left-0 top-0 h-5 w-full" />

                        <span className="absolute left-1/2 top-2.5 z-10 h-4 w-4 -translate-x-1/2 rotate-45 border-l border-t border-black/6 bg-white" />

                        <div className="relative overflow-hidden rounded-2xl border border-black/6 bg-white p-2.5 shadow-[0_25px_65px_rgba(0,35,111,0.18)]">
                          <div className="mb-2 border-b border-black/6 px-3 pb-2 pt-1">
                          ...
                          {link.children!.map((subLink, index) => (
                            ...
                            >
                              <span className="flex min-w-0 items-center gap-3">
                                <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-md bg-blue-02/6 text-[10px] font-bold text-blue-02 transition-all duration-300 group-hover/item:bg-red-01 group-hover/item:text-white">
              ...
              <ul className="space-y-2">
                {navLinks.map((link) => {
                  ...
                  return (
                    <li
                      key={link.name}
                      className="overflow-hidden rounded-2xl border border-black/6 bg-[#f8fafc]"
                    >
                      ...
                      <AnimatePresence initial={false}>
                        {hasChildren && isMobileDropdownOpen && (
                          ...
                          >
                            <div className="space-y-1 border-t border-black/6 bg-white p-2">
